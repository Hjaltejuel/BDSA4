...
namespace BDSA2017.Assignment04.Tests
{
    ...
    {
        List<Cars> rangeCars;
        List<Tracks> rangeTracks;
        List<Races> rangeRaces;
        List<CarInRaces> rangeCarInRaces;
        public QueriesTests()
        {
            rangeCars = new List<Cars> { new Cars() {  DriverName = "Hans", Name ="WW"},
                                         new Cars() {  DriverName = "Lars", Name ="WP"},
                                         new Cars() {  DriverName = "Karl", Name ="PW"},
                                         new Cars() {  DriverName = "Mans", Name ="PP"}
            };
            rangeTracks = new List<Tracks> { new Tracks() {  BestTime = 2200000000, Length = 5.5, MaxCars  = 76, Name = "LongTrack"},
            ...
            rangeRaces = new List<Races> { new Races() { Tracks = rangeTracks[0], ActualEndTime = new DateTime(1999,5,3), ActualStartTime = new DateTime(1999,3,4),
            ...
            rangeCarInRaces = new List<CarInRaces> { new CarInRaces() { Cars = rangeCars[0],Races = rangeRaces[0], BestLap = 10000000, EndPosition =5, StartPosition = 1,TotalRaceTime = 20020},
        ...
        public void TestTrackInfo()
        {
            ...
            using (RaceContext context = new RaceContext())
            {
                ...
                var trackInfo = querie.GetTrackInfo(rangeTracks[0].Id);
                var hello = 0;
